                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            localModel!.duration_start
                                                            .toString() ==
                                                        'null' ||
                                                    localModel!.duration_current
                                                            .toString() ==
                                                        'null' ||
                                                    localModel!.duration_start
                                                            .toString() ==
                                                    ...
                                                    localModel!.duration_current
                                                        ...
                                                        ''
                                                ? ''
                                                : ('${DateTime.parse(localModel!.duration_current.toString()).difference(DateTime.parse(localModel!.duration_start.toString())).inDays}d ${DateTime.parse(localModel!.duration_current.toString()).difference(DateTime.parse(localModel!.duration_start.toString())).inHours % 24}h')
                                                    .toString(),
                                            style: poppinsSemiBold.copyWith(
                                              fontSize: 14,
                                              color: AppColors.purpleDark,
...
//                                 ),
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: ListView.separated(
                                            ...
                                            itemCount: model
                                                        ...
                                                        .length <
                                                    50
                                                ? model.earnings.thisMonthOrders
                                                    .length
                                                : 50,
                                            ...
                                            itemBuilder: (cnx, index) {
                                              var item = model.earnings
                                                  .thisMonthOrders[index];
                                              return Container(
                                                padding:
  ...
  _lastWeekEarning() {
    ...
    data = [
      _SalesData(
          'Mon',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'mon') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'mon')!
                  .total_earning),
          localModel!.thisWeekEarning.firstWhereOrNull(
      ...
      _SalesData(
          'Tue',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'tue') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
      ...
      _SalesData(
          'Wed',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'wed') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
      ...
      _SalesData(
          'Thu',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'thu') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
      ...
      _SalesData(
          'Fri',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'fri') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
      ...
      _SalesData(
          'Sat',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'sat') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
      ...
      _SalesData(
          'Sun',
          localModel!.thisWeekEarning.firstWhereOrNull(
                      (element) => element.day.toLowerCase() == 'sun') ==
                  null
              ? 0
              : double.parse(localModel!.thisWeekEarning
                  .firstWhereOrNull(
